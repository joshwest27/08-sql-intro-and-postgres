...
app.get('/new', (request, response) => {
  ...
  // Get is 2 on the diagram, and responds to read in CRUD. Send file corresponds to 5 in the diagram update in CRUD. No interaction with article.js. serving new html page. 
...
app.get('/articles', (request, response) => {
  // COMMENT: What number(s) of the full-stack-diagram.png image correspond to the following line of code? Which method of article.js is interacting with this particular piece of `server.js`? What part of CRUD is being enacted/managed by this particular piece of code?
  // client.query is 3 on the diagram, the .then is 4 on the diagram, the response.send is 5.  This is still read in CRUD.
...
function loadArticles() {
  // COMMENT: What number(s) of the full-stack-diagram.png image correspond to the following line of code? Which method of article.js is interacting with this particular piece of `server.js`? What part of CRUD is being enacted/managed by this particular piece of code?
  // This Crud create. query is 3, then is 4.
...
function loadDB() {
  // COMMENT: What number(s) of the full-stack-diagram.png image correspond to the following line of code? Which method of article.js is interacting with this particular piece of `server.js`? What part of CRUD is being enacted/managed by this particular piece of code?
  // This is Crud read. query is 3, then is 4. 
  client.query(`
